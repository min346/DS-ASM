...
st.markdown(
    ...
    **Welcome to the AuraCare Heart Disease Predictor.**  
    ❤️‍🩹 Enter your details below to check your heart disease risk instantly.
    """
)
...
if submitted:
    ...
    with result_box:
        ...
        if proba < 0.125:
            st.info("✅ Very low risk. No signs of heart disease. Keep up a healthy lifestyle with good diet, exercise, and enough sleep.")
        
        elif proba < 0.25:
            st.warning("⚠️ Low-to-moderate risk. Currently predicted as NO Heart Disease, but some risk factors exist. Monitor your habits and consider preventive health check-ups.")
        
        elif proba < 0.375:
            st.error("🚨 Moderate risk. Prediction: HAS Heart Disease. Some strong risk factors detected. It is recommended to consult a doctor for further advice.")
        
        else:  # proba between 0.375 and 0.5
